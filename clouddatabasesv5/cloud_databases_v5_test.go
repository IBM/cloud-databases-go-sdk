...
var _ = Describe(`CloudDatabasesV5`, func() {
	...
	Describe(`GetAutoscalingCapability(getAutoscalingCapabilityOptions *GetAutoscalingCapabilityOptions) - Operation response error`, func() {
		getAutoscalingCapabilityPath := "/deployments/testString/capability/autoscaling"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getAutoscalingCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetAutoscalingCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetAutoscalingCapabilityRequestDeployment model
				getAutoscalingCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetAutoscalingCapabilityRequestDeployment)
				getAutoscalingCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				getAutoscalingCapabilityRequestDeploymentModel.Version = core.StringPtr("10")
				getAutoscalingCapabilityRequestDeploymentModel.Platform = core.StringPtr("satellite")

				// Construct an instance of the GetAutoscalingCapabilityOptions model
				getAutoscalingCapabilityOptionsModel := new(clouddatabasesv5.GetAutoscalingCapabilityOptions)
				getAutoscalingCapabilityOptionsModel.ID = core.StringPtr("testString")
				getAutoscalingCapabilityOptionsModel.Deployment = getAutoscalingCapabilityRequestDeploymentModel
				getAutoscalingCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetAutoscalingCapability(getAutoscalingCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetAutoscalingCapability(getAutoscalingCapabilityOptions *GetAutoscalingCapabilityOptions)`, func() {
		getAutoscalingCapabilityPath := "/deployments/testString/capability/autoscaling"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"capability": [{"autoscaling": "mongodb", "encryption": true, "endpoints": true, "groups": "postgresql", "regions": "classic", "remotes": "postgresql", "versions": "classic"}]}`)
				}))
			})
			It(`Invoke GetAutoscalingCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetAutoscalingCapabilityWithContext(ctx, getAutoscalingCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetAutoscalingCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetAutoscalingCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetAutoscalingCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetAutoscalingCapabilityOptions model with no property values
				getAutoscalingCapabilityOptionsModelNew := new(clouddatabasesv5.GetAutoscalingCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetAutoscalingCapability(getAutoscalingCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetEncryptionCapability(getEncryptionCapabilityOptions *GetEncryptionCapabilityOptions) - Operation response error`, func() {
		getEncryptionCapabilityPath := "/deployments/testString/capability/encryption"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getEncryptionCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetEncryptionCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetEncryptionCapabilityRequestDeployment model
				getEncryptionCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetEncryptionCapabilityRequestDeployment)
				getEncryptionCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")

				// Construct an instance of the GetEncryptionCapabilityOptions model
				getEncryptionCapabilityOptionsModel := new(clouddatabasesv5.GetEncryptionCapabilityOptions)
				getEncryptionCapabilityOptionsModel.ID = core.StringPtr("testString")
				getEncryptionCapabilityOptionsModel.Deployment = getEncryptionCapabilityRequestDeploymentModel
				getEncryptionCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetEncryptionCapability(getEncryptionCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetEncryptionCapability(getEncryptionCapabilityOptions *GetEncryptionCapabilityOptions)`, func() {
		getEncryptionCapabilityPath := "/deployments/testString/capability/encryption"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetEncryptionCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetEncryptionCapabilityWithContext(ctx, getEncryptionCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetEncryptionCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetEncryptionCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetEncryptionCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetEncryptionCapabilityOptions model with no property values
				getEncryptionCapabilityOptionsModelNew := new(clouddatabasesv5.GetEncryptionCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetEncryptionCapability(getEncryptionCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetEndpointsCapability(getEndpointsCapabilityOptions *GetEndpointsCapabilityOptions) - Operation response error`, func() {
		getEndpointsCapabilityPath := "/deployments/testString/capability/endpoints"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getEndpointsCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetEndpointsCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetEndpointsCapabilityRequestDeployment model
				getEndpointsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetEndpointsCapabilityRequestDeployment)
				getEndpointsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("mongoDB")

				// Construct an instance of the GetEndpointsCapabilityOptions model
				getEndpointsCapabilityOptionsModel := new(clouddatabasesv5.GetEndpointsCapabilityOptions)
				getEndpointsCapabilityOptionsModel.ID = core.StringPtr("testString")
				getEndpointsCapabilityOptionsModel.Deployment = getEndpointsCapabilityRequestDeploymentModel
				getEndpointsCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetEndpointsCapability(getEndpointsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetEndpointsCapability(getEndpointsCapabilityOptions *GetEndpointsCapabilityOptions)`, func() {
		getEndpointsCapabilityPath := "/deployments/testString/capability/endpoints"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetEndpointsCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetEndpointsCapabilityWithContext(ctx, getEndpointsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetEndpointsCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetEndpointsCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetEndpointsCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetEndpointsCapabilityOptions model with no property values
				getEndpointsCapabilityOptionsModelNew := new(clouddatabasesv5.GetEndpointsCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetEndpointsCapability(getEndpointsCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetGroupsCapability(getGroupsCapabilityOptions *GetGroupsCapabilityOptions) - Operation response error`, func() {
		getGroupsCapabilityPath := "/deployments/testString/capability/groups"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getGroupsCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetGroupsCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetGroupsCapabilityRequestDeployment model
				getGroupsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetGroupsCapabilityRequestDeployment)
				getGroupsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("mongoDB")

				// Construct an instance of the GetGroupsCapabilityOptions model
				getGroupsCapabilityOptionsModel := new(clouddatabasesv5.GetGroupsCapabilityOptions)
				getGroupsCapabilityOptionsModel.ID = core.StringPtr("testString")
				getGroupsCapabilityOptionsModel.Deployment = getGroupsCapabilityRequestDeploymentModel
				getGroupsCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetGroupsCapability(getGroupsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetGroupsCapability(getGroupsCapabilityOptions *GetGroupsCapabilityOptions)`, func() {
		getGroupsCapabilityPath := "/deployments/testString/capability/groups"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetGroupsCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetGroupsCapabilityWithContext(ctx, getGroupsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetGroupsCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetGroupsCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetGroupsCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetGroupsCapabilityOptions model with no property values
				getGroupsCapabilityOptionsModelNew := new(clouddatabasesv5.GetGroupsCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetGroupsCapability(getGroupsCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetRegionsCapability(getRegionsCapabilityOptions *GetRegionsCapabilityOptions) - Operation response error`, func() {
		getRegionsCapabilityPath := "/deployments/testString/capability/regions"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getRegionsCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetRegionsCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetRegionsCapabilityRequestDeployment model
				getRegionsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetRegionsCapabilityRequestDeployment)
				getRegionsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				getRegionsCapabilityRequestDeploymentModel.Version = core.StringPtr("10")
				getRegionsCapabilityRequestDeploymentModel.Platform = core.StringPtr("satellite")

				// Construct an instance of the GetRegionsCapabilityOptions model
				getRegionsCapabilityOptionsModel := new(clouddatabasesv5.GetRegionsCapabilityOptions)
				getRegionsCapabilityOptionsModel.ID = core.StringPtr("testString")
				getRegionsCapabilityOptionsModel.Deployment = getRegionsCapabilityRequestDeploymentModel
				getRegionsCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetRegionsCapability(getRegionsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetRegionsCapability(getRegionsCapabilityOptions *GetRegionsCapabilityOptions)`, func() {
		getRegionsCapabilityPath := "/deployments/testString/capability/regions"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetRegionsCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetRegionsCapabilityWithContext(ctx, getRegionsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetRegionsCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetRegionsCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetRegionsCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetRegionsCapabilityOptions model with no property values
				getRegionsCapabilityOptionsModelNew := new(clouddatabasesv5.GetRegionsCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetRegionsCapability(getRegionsCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetRemotesCapability(getRemotesCapabilityOptions *GetRemotesCapabilityOptions) - Operation response error`, func() {
		getRemotesCapabilityPath := "/deployments/testString/capability/remotes"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getRemotesCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetRemotesCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetRemotesCapabilityRequestDeployment model
				getRemotesCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetRemotesCapabilityRequestDeployment)
				getRemotesCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")

				// Construct an instance of the GetRemotesCapabilityOptions model
				getRemotesCapabilityOptionsModel := new(clouddatabasesv5.GetRemotesCapabilityOptions)
				getRemotesCapabilityOptionsModel.ID = core.StringPtr("testString")
				getRemotesCapabilityOptionsModel.Deployment = getRemotesCapabilityRequestDeploymentModel
				getRemotesCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetRemotesCapability(getRemotesCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetRemotesCapability(getRemotesCapabilityOptions *GetRemotesCapabilityOptions)`, func() {
		getRemotesCapabilityPath := "/deployments/testString/capability/remotes"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetRemotesCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetRemotesCapabilityWithContext(ctx, getRemotesCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetRemotesCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetRemotesCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetRemotesCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetRemotesCapabilityOptions model with no property values
				getRemotesCapabilityOptionsModelNew := new(clouddatabasesv5.GetRemotesCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetRemotesCapability(getRemotesCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetVersionsCapability(getVersionsCapabilityOptions *GetVersionsCapabilityOptions) - Operation response error`, func() {
		getVersionsCapabilityPath := "/deployments/testString/capability/versions"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(getVersionsCapabilityPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke GetVersionsCapability with error: Operation response processing error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the GetVersionsCapabilityRequestDeployment model
				getVersionsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetVersionsCapabilityRequestDeployment)
				getVersionsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")

				// Construct an instance of the GetVersionsCapabilityOptions model
				getVersionsCapabilityOptionsModel := new(clouddatabasesv5.GetVersionsCapabilityOptions)
				getVersionsCapabilityOptionsModel.ID = core.StringPtr("testString")
				getVersionsCapabilityOptionsModel.Deployment = getVersionsCapabilityRequestDeploymentModel
				getVersionsCapabilityOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := cloudDatabasesService.GetVersionsCapability(getVersionsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetVersionsCapability(getVersionsCapabilityOptions *GetVersionsCapabilityOptions)`, func() {
		getVersionsCapabilityPath := "/deployments/testString/capability/versions"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke GetVersionsCapability successfully with retries`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := cloudDatabasesService.GetVersionsCapabilityWithContext(ctx, getVersionsCapabilityOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetVersionsCapability successfully`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := cloudDatabasesService.GetVersionsCapability(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetVersionsCapability with error: Operation validation and request error`, func() {
				cloudDatabasesService, serviceErr := clouddatabasesv5.NewCloudDatabasesV5(&clouddatabasesv5.CloudDatabasesV5Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetVersionsCapabilityOptions model with no property values
				getVersionsCapabilityOptionsModelNew := new(clouddatabasesv5.GetVersionsCapabilityOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = cloudDatabasesService.GetVersionsCapability(getVersionsCapabilityOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewGetAutoscalingCapabilityOptions successfully`, func() {
				// Construct an instance of the GetAutoscalingCapabilityRequestDeployment model
				getAutoscalingCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetAutoscalingCapabilityRequestDeployment)
				Expect(getAutoscalingCapabilityRequestDeploymentModel).ToNot(BeNil())
				getAutoscalingCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				getAutoscalingCapabilityRequestDeploymentModel.Version = core.StringPtr("10")
				getAutoscalingCapabilityRequestDeploymentModel.Platform = core.StringPtr("satellite")
				Expect(getAutoscalingCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("PostgreSQL")))
				Expect(getAutoscalingCapabilityRequestDeploymentModel.Version).To(Equal(core.StringPtr("10")))
				Expect(getAutoscalingCapabilityRequestDeploymentModel.Platform).To(Equal(core.StringPtr("satellite")))

				// Construct an instance of the GetAutoscalingCapabilityOptions model
				id := "testString"
				getAutoscalingCapabilityOptionsModel := cloudDatabasesService.NewGetAutoscalingCapabilityOptions(id)
				getAutoscalingCapabilityOptionsModel.SetID("testString")
				getAutoscalingCapabilityOptionsModel.SetDeployment(getAutoscalingCapabilityRequestDeploymentModel)
				getAutoscalingCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getAutoscalingCapabilityOptionsModel).ToNot(BeNil())
				Expect(getAutoscalingCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getAutoscalingCapabilityOptionsModel.Deployment).To(Equal(getAutoscalingCapabilityRequestDeploymentModel))
				Expect(getAutoscalingCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewGetEncryptionCapabilityOptions successfully`, func() {
				// Construct an instance of the GetEncryptionCapabilityRequestDeployment model
				getEncryptionCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetEncryptionCapabilityRequestDeployment)
				Expect(getEncryptionCapabilityRequestDeploymentModel).ToNot(BeNil())
				getEncryptionCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				Expect(getEncryptionCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("PostgreSQL")))

				// Construct an instance of the GetEncryptionCapabilityOptions model
				id := "testString"
				getEncryptionCapabilityOptionsModel := cloudDatabasesService.NewGetEncryptionCapabilityOptions(id)
				getEncryptionCapabilityOptionsModel.SetID("testString")
				getEncryptionCapabilityOptionsModel.SetDeployment(getEncryptionCapabilityRequestDeploymentModel)
				getEncryptionCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getEncryptionCapabilityOptionsModel).ToNot(BeNil())
				Expect(getEncryptionCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getEncryptionCapabilityOptionsModel.Deployment).To(Equal(getEncryptionCapabilityRequestDeploymentModel))
				Expect(getEncryptionCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewGetEndpointsCapabilityOptions successfully`, func() {
				// Construct an instance of the GetEndpointsCapabilityRequestDeployment model
				getEndpointsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetEndpointsCapabilityRequestDeployment)
				Expect(getEndpointsCapabilityRequestDeploymentModel).ToNot(BeNil())
				getEndpointsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("mongoDB")
				Expect(getEndpointsCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("mongoDB")))

				// Construct an instance of the GetEndpointsCapabilityOptions model
				id := "testString"
				getEndpointsCapabilityOptionsModel := cloudDatabasesService.NewGetEndpointsCapabilityOptions(id)
				getEndpointsCapabilityOptionsModel.SetID("testString")
				getEndpointsCapabilityOptionsModel.SetDeployment(getEndpointsCapabilityRequestDeploymentModel)
				getEndpointsCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getEndpointsCapabilityOptionsModel).ToNot(BeNil())
				Expect(getEndpointsCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getEndpointsCapabilityOptionsModel.Deployment).To(Equal(getEndpointsCapabilityRequestDeploymentModel))
				Expect(getEndpointsCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewGetGroupsCapabilityOptions successfully`, func() {
				// Construct an instance of the GetGroupsCapabilityRequestDeployment model
				getGroupsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetGroupsCapabilityRequestDeployment)
				Expect(getGroupsCapabilityRequestDeploymentModel).ToNot(BeNil())
				getGroupsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("mongoDB")
				Expect(getGroupsCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("mongoDB")))

				// Construct an instance of the GetGroupsCapabilityOptions model
				id := "testString"
				getGroupsCapabilityOptionsModel := cloudDatabasesService.NewGetGroupsCapabilityOptions(id)
				getGroupsCapabilityOptionsModel.SetID("testString")
				getGroupsCapabilityOptionsModel.SetDeployment(getGroupsCapabilityRequestDeploymentModel)
				getGroupsCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getGroupsCapabilityOptionsModel).ToNot(BeNil())
				Expect(getGroupsCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getGroupsCapabilityOptionsModel.Deployment).To(Equal(getGroupsCapabilityRequestDeploymentModel))
				Expect(getGroupsCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewGetRegionsCapabilityOptions successfully`, func() {
				// Construct an instance of the GetRegionsCapabilityRequestDeployment model
				getRegionsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetRegionsCapabilityRequestDeployment)
				Expect(getRegionsCapabilityRequestDeploymentModel).ToNot(BeNil())
				getRegionsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				getRegionsCapabilityRequestDeploymentModel.Version = core.StringPtr("10")
				getRegionsCapabilityRequestDeploymentModel.Platform = core.StringPtr("satellite")
				Expect(getRegionsCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("PostgreSQL")))
				Expect(getRegionsCapabilityRequestDeploymentModel.Version).To(Equal(core.StringPtr("10")))
				Expect(getRegionsCapabilityRequestDeploymentModel.Platform).To(Equal(core.StringPtr("satellite")))

				// Construct an instance of the GetRegionsCapabilityOptions model
				id := "testString"
				getRegionsCapabilityOptionsModel := cloudDatabasesService.NewGetRegionsCapabilityOptions(id)
				getRegionsCapabilityOptionsModel.SetID("testString")
				getRegionsCapabilityOptionsModel.SetDeployment(getRegionsCapabilityRequestDeploymentModel)
				getRegionsCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getRegionsCapabilityOptionsModel).ToNot(BeNil())
				Expect(getRegionsCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getRegionsCapabilityOptionsModel.Deployment).To(Equal(getRegionsCapabilityRequestDeploymentModel))
				Expect(getRegionsCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewGetRemotesCapabilityOptions successfully`, func() {
				// Construct an instance of the GetRemotesCapabilityRequestDeployment model
				getRemotesCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetRemotesCapabilityRequestDeployment)
				Expect(getRemotesCapabilityRequestDeploymentModel).ToNot(BeNil())
				getRemotesCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				Expect(getRemotesCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("PostgreSQL")))

				// Construct an instance of the GetRemotesCapabilityOptions model
				id := "testString"
				getRemotesCapabilityOptionsModel := cloudDatabasesService.NewGetRemotesCapabilityOptions(id)
				getRemotesCapabilityOptionsModel.SetID("testString")
				getRemotesCapabilityOptionsModel.SetDeployment(getRemotesCapabilityRequestDeploymentModel)
				getRemotesCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getRemotesCapabilityOptionsModel).ToNot(BeNil())
				Expect(getRemotesCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getRemotesCapabilityOptionsModel.Deployment).To(Equal(getRemotesCapabilityRequestDeploymentModel))
				Expect(getRemotesCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewGetVersionsCapabilityOptions successfully`, func() {
				// Construct an instance of the GetVersionsCapabilityRequestDeployment model
				getVersionsCapabilityRequestDeploymentModel := new(clouddatabasesv5.GetVersionsCapabilityRequestDeployment)
				Expect(getVersionsCapabilityRequestDeploymentModel).ToNot(BeNil())
				getVersionsCapabilityRequestDeploymentModel.DeploymentType = core.StringPtr("PostgreSQL")
				Expect(getVersionsCapabilityRequestDeploymentModel.DeploymentType).To(Equal(core.StringPtr("PostgreSQL")))

				// Construct an instance of the GetVersionsCapabilityOptions model
				id := "testString"
				getVersionsCapabilityOptionsModel := cloudDatabasesService.NewGetVersionsCapabilityOptions(id)
				getVersionsCapabilityOptionsModel.SetID("testString")
				getVersionsCapabilityOptionsModel.SetDeployment(getVersionsCapabilityRequestDeploymentModel)
				getVersionsCapabilityOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getVersionsCapabilityOptionsModel).ToNot(BeNil())
				Expect(getVersionsCapabilityOptionsModel.ID).To(Equal(core.StringPtr("testString")))
				Expect(getVersionsCapabilityOptionsModel.Deployment).To(Equal(getVersionsCapabilityRequestDeploymentModel))
				Expect(getVersionsCapabilityOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
